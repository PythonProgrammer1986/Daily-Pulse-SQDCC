    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {kpis.map((kpi) => (
          <div
            key={kpi.id}
            className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex flex-col h-full hover:shadow-md transition"
          >
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-600 italic">
                "{kpi.remarks || "No remarks recorded"}"
              </p>
            </div>
          </div>
        ))}
          ...
          <div className="bg-white rounded-lg shadow-2xl w-full max-w-md">
            <div className="p-6 border-b border-gray-100 flex justify-between items-center bg-[#FDB913]">
              <h2 className="text-xl font-bold">
                {editingKpi ? "Edit KPI" : "New KPI Target"}
              </h2>
              <button
            ...
            <form onSubmit={handleSaveKpi} className="p-6 space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full border border-gray-200 rounded px-3 py-2"
                  placeholder="Obstacles or milestones..."
                ></textarea>
              </div>
