...
const ProjectBoard: React.FC<ProjectBoardProps> = ({
  ...
  const handleSaveProject = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (editingProject) {
      updateProjects(
        projects.map((p) =>
          p.id === editingProject.id ? { ...p, ...projData } : p,
        ),
      );
    } else {
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-500 font-medium">
            Long-term projects linked to breakthrough objectives
          </p>
        </div>
        <button
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          <div className="bg-white rounded-lg shadow-2xl w-full max-w-xl max-h-[90vh] flex flex-col">
            <div className="p-6 border-b border-gray-100 flex justify-between items-center bg-[#FDB913] shrink-0">
            ...
            >
              <div>
                ...
                <input
                  ...
                  className="w-full border border-gray-200 rounded px-3 py-2 focus:ring-1 focus:ring-black outline-none"
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    step="0.5"
                    name="hours"
                    defaultValue={editingProject?.hours || 0}
                    className="w-full border border-gray-200 rounded px-3 py-2"
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    className="w-full h-2 bg-zinc-100 rounded-lg appearance-none cursor-pointer accent-[#FDB913]"
                  />
                </div>
              </div>
              <div>
